    ...
    <div className="bg-gray-100 text-gray-800">
      ...
      <section className="text-center py-16 bg-white">
        ...
        <p className="text-gray-500 max-w-xl mx-auto">
          We're here to listen. Kids Empathy Initiative is a charity
          organization dedicated to uplifting underprivileged children through
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-6">
            Reach out to us to support, volunteer, or collaborate. Together, we
            can build a better future for every child.
          </p>

          <div className="space-y-5 text-gray-700 text-sm">
            <div className="flex items-center gap-3">
              <span className="text-[#fa0262] text-xl">
                <FaLocationArrow />
              </span>
              <p>
                9 Albarka street , S A lawa close , olive primary school Bodija
                Ibadan
              </p>
            </div>
            <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <p>kidsempathyinitiative@outlook.com</p>
            </div>
          </div>
